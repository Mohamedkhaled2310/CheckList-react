    ...
    <>
      <div className="text-center h-screen">
        ...
        <div className="flex-grow flex items-center justify-center sticky top-[100vh]">
          <div className="w-full h-10 bg-teal-500 flex items-center justify-center">
            <h1 className="text-center italic text-orange-900">Start adding some items to your packing list</h1>
        ...
        <div className='flex justify-center items-center gap-3 sticky top-[90vh]'>
          ...
          <button
            className='bg-orange-300 hover:bg-orange-900 font-bold py-2 px-4 rounded-full'
            onClick={sortItems}
          >
